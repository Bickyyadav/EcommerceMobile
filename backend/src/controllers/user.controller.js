...
export async function addAddress(req, res) {
    try {
        ...
        //we are pusing the address simply we can also add but pushing means live the past addresss as usual and add this address to this column
        user.addresses.push({
            label,
            fullName,
            streetAddress,
...
export async function updateAddress(req, res) {
    try {
        const { label, fullName, streetAddress, city, state, zipCode, phoneNumber, isDefault } = req.body;
        const user = req.user;
        //this id is getting when we click the address to update 
